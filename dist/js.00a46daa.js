...
const typeWriter = (str, sel, typeDelay = 10) => {
...
const loopThrough = (arr, sel, fn, hold = 5000, typeDelay) => {
  let count = 0;
  return {
    play: function timer() {
...
let isPlaying = true;
const playButton = (0, _timer.loopThrough)(_quotes.quotes, main, _timer.typeWriter, 4000, 20);
playButton.play();
...
},{"./quotes":"js/quotes.js","./timer":"js/timer.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
